    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-3">
                ...
                <SelectInput id="country" placeholder="Select a country" class="mt-1 block w-full border-solid" :options="props.countries" :modelValue="form.country_id" @update="setCountry" required></SelectInput>
...
const submit = () => {
    if(form.country_id == '0'){
        return form.errors.country_id = 'Please select a country';
    }
